...
function __addRelease(e, t, n, i, a, o, r) {
    if (void 0 === r && (r = null), "string" != typeof r || (r = "_release" + r, "1" != aidn.util.getCookie(r))) {
        "string" != typeof a && (a = "New Release");
        for (var d = "Sawarabi+Gothic", s = !1, l = "Montserrat", c = !1, u = $("link"), h = 0, f = u.length; h < f; h++) {
            var p = u[h].getAttribute("href");
            p && (0 < p.indexOf(d) && (s = !0), 0 < p.indexOf(l) && (c = !0))
        }
        if (!s || !c) {
            var v = '<link href="https://fonts.googleapis.com/css?family=';
            s || (v += d), s || c || (v += "|"), c || (v += l), v += '&display=swap" rel="stylesheet">', $("head").append(v)
        }
        _isJapanese || (n = i);
        ...
        var w = "bottom";
        1 == o && (w = "top");
        var b = "white-space: nowrap; position: fixed; " + w + ": 0; z-index: 100000; left: 50%; transform: translateX(-50%); width:100%; max-width: 480px; color: #000; background:rgba(247, 247, 247, 0.95); text-align:left; cursor:pointer; letter-spacing: .4rem; line-height: 1;",
            y = '<div id="rel_open' + g + '" style="' + (b += "font-family:'Montserrat Light',Montserrat,'Sawarabi Gothic','游ゴシック','Yu Gothic','游ゴシック体',YuGothic,'Yu Gothic UI','ヒラギノ角ゴ Pro W3','Hiragino Kaku Gothic Pro','Meiryo UI','メイリオ',Meiryo,sans-serif") + '">';
        y += '<img src="' + e + '" style="width:calc(50px + 3vh); height:calc(50px + 3vh); margin: calc(5px + 1vh); vertical-align:middle; border:1px solid #ccc;">', y += '<p style="display:inline-block; vertical-align:middle; letter-spacing:0.13rem; line-height:1.5; font-weight:bold;">', y += '<span style="font-size:calc(0.5rem + 0.7vh);" class="blink">' + a + "</span><br>", y += '<span style="font-size:' + m + ';">' + n + "</span>", y += "</p>", y += '<p id="rel_close' + g + '" style="position:absolute; right:0; top:-1.2vh; font-size:calc(2rem + 3vh);">×</p>', y += "</div>", $("body").append(y), y = "<style>\n.blink{\n", y += "-webkit-animation: animFade 0.6s ease-in infinite alternate;\n", y += "animation: animFade 0.6s ease-in infinite alternate;\n", y += "}\n", y += "@-webkit-keyframes animFade {\n 0% { opacity: 1; }\n 100% { opacity: 0.1; } \n}\n", y += "@keyframes animFade {\n 0% { opacity: 1; }\n 100% { opacity: 0.1; } \n}\n", y += "</style>", $("head").append(y), $("#rel_open" + g).on("click", function(e) {
            e.preventDefault(), location.href = t
        }), $("#rel_close" + g).on("click", function(e) {
            e.preventDefault(), e.stopPropagation(), $("#rel_open" + g).hide(), r && aidn.util.setCookie(r, "1", 86400, "/")
        })
    }
}
...
function __checkInit() {
        ...
        e && "string" == typeof e && ($.ajax({
            ...
            if (_isJapanese || null != document.getElementById("google_translate_element") && $.getScript("//translate.google.com/translate_a/element.js?cb=__googleTranslateElementInit", function() {
                    ...
                    setInterval(function() {
                        $(".goog-te-banner-frame").length && ("none" == $(".skiptranslate").css("display") ? (e && ("block" == $("#bt_menu").css("display") ? $("#menu, #bt_menu").css("top", 0) : $("#menu").css("top", 0)), t && ($("#lyrics_base").css({
                            top: 0,
                            height: "100%"
                        }), $("#bt_close").css("top", 0))) : (e && ("block" == $("#bt_menu").css("display") ? $("#menu, #bt_menu").css("top", 39) : $("#menu").css("top", 39)), t && ($("#lyrics_base").css({
                            top: 39,
                    ...
                    var i = setInterval(function() {
                        ...
                        }), $("iframe:first").contents().find(".goog-te-banner").css("background", "#FFF"), $("iframe:first").contents().find(".goog-te-button").css("display", "none"), $("div.skiptranslate").css("opacity", 1), clearInterval(i))
                    }, 100)
            ...
            for (o = [{
                    ...
                    title: "MKLYPN",
                    key: "_mklypn"
                }], r = location.href, d = !1, t = "", l = 0; l < o.length; l++) {
                var b = o[l];
                if (0 < r.indexOf(b.path)) {
                    d = !0, t = "_sub", b.key && (t = b.key), b.desc && (p = b.desc), b.link && (v = b.link), b.imgPath && (g = b.imgPath), b.title && (m = b.title, w = b.title), b.titleEn && (w = b.titleEn), "boolean" == typeof b.topFlag && (f = b.topFlag);
                    break
                }
            }
            if (0 < $("#aidnx").length || d) {
                var y = (r = 0 <= (r = location.href.split("#")[0].split("?")[0]).indexOf("aidn.jp/") ? r.split("aidn.jp/")[1] : r.split("aidn/")[1]).split("/").length,
                    _ = "";
                for (l = 0; l < y - 1; l++) _ += "../";
                g.indexOf("http") < 0 && (g = _ + g), v.indexOf("http") < 0 && (v = _ + v), __addRelease(g, v, m, w, p, f, t)
            }
            if (0 < $("#aidn").length && (_active = !1), 0 < $("#aidnx").length && (_active = !1, $("#bt_menu").on("click", function() {
                ...
                var k = "";
                if (k += '<a href="' + x + '" target="_blank"><div class="adv_con">', k += '<p class="text">' + aidn.constant.advTex + "</p>", k += '<p class="image"><img src="' + aidn.constant.advImg + '" alt="' + aidn.constant.advAlt + '" /></p>', k += "</div></a>", 0 < $(".adv").length);
                else {
                    var E = $("#common_back");
                    0 < E.length && (k = '<div class="adv"><div class="hr_top"></div>' + k + "</div>", $("body").css("overflow", "auto"), E.after(k))
                }
            }
        })
    }
    ...
    aidn.audio.init();
    var f, p, u, h, v, g, m, w, b, y, _, x, t, k = this,
        E = [],
        O = 0,
        S = 100,
        A = -1,
    ...
    this.load = function(e, u, t, n) {
        ...
        function c() {
            ...
            e = a ? i.buffer : h.response, f.decodeAudioData(e, function(e) {
                ...
                S = (p = e).duration, u && u(p), F && (F = !1, k.play(m, w, b, y, _, x))
            }, function() {})
        }
        if (a) c();
        else {
        ...
        if (m = e, w = t, b = n, y = i, _ = a, x = o, !p) return F = !0, void console.log('call "load" method before "play"');
        void 0 === e && (e = 0), void 0 === t && (t = !1), void 0 === i && (i = 0), void 0 === a ? a = I : I = a, void 0 === o && (o = 0), (u = f.createBufferSource()).buffer = p, u.loop = t, u.onended = T, v || (v = f.createGain());
        var r = [u, v];
        ...
        if (u.start ? u.start(f.currentTime + o, e) : u.noteOn(e), O = f.currentTime - e, this._source = u, this.nodeGain = v, 0 < i && "undefined" != typeof jQuery ? (k.volume = 0, $(k).stop().animate({
                volume: a
            }, 1e3 * i, "easeInSine")) : k.volume = a, n) var c = setInterval(function() {
        ...
        return void 0 === e && (e = 0), (g = f.createBiquadFilter()).type = e, g
