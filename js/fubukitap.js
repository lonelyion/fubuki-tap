        ...
        B && ($("#bt_fs").css("display", "block"), $("#bt_fs").click(function(n) {
            ...
            switch (x) {
                case 1:
                    ...
                    break;
                default:
                    location.href = "https://fubuki.moe"
            }
        }), $("#bt_feedback a").click(n), $("#bt_backtrack a").click(o);
        var G, A, y = aidn.util.checkJapanese(),
            E = aidn.util.checkMobile(),
            w = "https://tap.fubuki.moe",
            M = "FubukiTap";
        M += y ? ",白上フブキの誕生日プレゼント" : ",フブキch", $("#bt_tw").click(function(n) {
            var a = document.title;
            aidn.social.shareTw(w, !0, a, "lonely_ion", M)
        });
        var m, I, z, b = 0,
            x = 0,
            C = new function() {
            ...
            g = new function() {
                ...
                this.resize = function() {
                    ...
                    w = !0, b = new PIXI.Container, z.addChild(b), f = new PIXI.Container, z.addChild(f), (T = new n(b)).setColor(5228542, 0)
                }, this.start = function() {
